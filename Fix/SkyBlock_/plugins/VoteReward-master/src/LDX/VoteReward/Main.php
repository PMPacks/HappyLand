...
class Main extends PluginBase {
  ...
  public function rewardPlayer($player, $multiplier) {
    ...
    if($multiplier < 1) {
      $player->sendMessage("§l§b[§a VOTE §b ]§6 Bạn chưa vote, hãy vote ở §ebit.do/ark-vote !");
      return;
    }
    $clones = [];
    ...
    $player->sendMessage("§l§b[§a VOTE §b ]§6 You voted on $multiplier server list" . ($multiplier == 1 ? "" : "s") . "!");
  }
