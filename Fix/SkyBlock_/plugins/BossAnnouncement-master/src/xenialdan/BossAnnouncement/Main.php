...
class Main extends PluginBase implements Listener{
	...
	public function formatText(Player $player, string $text){
		...
		$text = str_replace("{money}", $this->getServer()->getPluginManager()->getPlugin("EconomyAPI")->myMoney($player->getName()), $text);
		$text = str_replace("{hour}", date('H'), $text);
		$text = str_replace("{coin}", $this->getServer()->getPluginManager()->getPlugin("PointAPI")->myMoney($player->getName()), $text);
