...
use NapThe\NapThe;
use NapThe\API\Vippay_API;
use pocketmine\command\CommandSender;
use NapThe\NapTheAPI;

class NapTheCommand extends PluginBase implements Listener {
    public function execute(NapThe $plugin, CommandSender $sender, $label, array $args):bool{
        ...
        $sender->sendMessage($plugin->prefix."§cĐã xảy ra lỗi, kiểm tra lại đi!");
