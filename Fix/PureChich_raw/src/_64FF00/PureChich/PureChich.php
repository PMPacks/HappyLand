...
namespace _64FF00\PureChich;

use _64FF00\PureChich\cmd\AddGroup;
use _64FF00\PureChich\cmd\AddParent;
use _64FF00\PureChich\cmd\DefGroup;
use _64FF00\PureChich\cmd\FPerms;
use _64FF00\PureChich\cmd\Groups;
use _64FF00\PureChich\cmd\GrpInfo;
use _64FF00\PureChich\cmd\ListGPerms;
use _64FF00\PureChich\cmd\ListUPerms;
use _64FF00\PureChich\cmd\PPInfo;
use _64FF00\PureChich\cmd\PPReload;
use _64FF00\PureChich\cmd\PPSudo;
use _64FF00\PureChich\cmd\RmGroup;
use _64FF00\PureChich\cmd\RmParent;
use _64FF00\PureChich\cmd\SetGPerm;
use _64FF00\PureChich\cmd\SetGroup;
use _64FF00\PureChich\cmd\SetUPerm;
use _64FF00\PureChich\cmd\UnsetGPerm;
use _64FF00\PureChich\cmd\UnsetUPerm;
use _64FF00\PureChich\cmd\UsrInfo;
use _64FF00\PureChich\data\UserDataManager;
use _64FF00\PureChich\noeul\NoeulAPI;
use _64FF00\PureChich\provider\DefaultProvider;
use _64FF00\PureChich\provider\MySQLProvider;
use _64FF00\PureChich\provider\ProviderInterface;
use _64FF00\PureChich\provider\YamlV1Provider;
use _64FF00\PureChich\task\PPExpDateCheckTask;
...
class PureChich extends PluginBase
{
    /*
    ...
    */
    ...
    private function registerCommands()
    {
        ...
        if($this->getNoeulAPI()->isNoeulEnabled())
            $commandMap->register("PureChich", new PPSudo($this, "ppsudo", $this->getMessage("cmds.ppsudo.desc") . ' #64FF00'));

        $commandMap->register("PureChich", new AddGroup($this, "addgroup1", $this->getMessage("cmds.addgroup.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new AddParent($this, "addparent1", $this->getMessage("cmds.addparent.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new DefGroup($this, "defgroup1", $this->getMessage("cmds.defgroup.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new FPerms($this, "fperms1", $this->getMessage("cmds.fperms.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new Groups($this, "groups1", $this->getMessage("cmds.groups.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new GrpInfo($this, "grpinfo1", $this->getMessage("cmds.grpinfo.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new ListGPerms($this, "listgperms1", $this->getMessage("cmds.listgperms.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new ListUPerms($this, "listuperms1", $this->getMessage("cmds.listuperms.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new PPInfo($this, "ppinfo1", $this->getMessage("cmds.ppinfo.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new PPReload($this, "ppreload1", $this->getMessage("cmds.ppreload.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new RmGroup($this, "rmgroup1", $this->getMessage("cmds.rmgroup.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new RmParent($this, "rmparent1", $this->getMessage("cmds.rmparent.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new SetGPerm($this, "setgperm1", $this->getMessage("cmds.setgperm.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new SetGroup($this, "setgroup1", $this->getMessage("cmds.setgroup.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new SetUPerm($this, "setuperm1", $this->getMessage("cmds.setuperm.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new UnsetGPerm($this, "unsetgperm1", $this->getMessage("cmds.unsetgperm.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new UnsetUPerm($this, "unsetuperm1", $this->getMessage("cmds.unsetuperm.desc") . ' #64FF00'));
        $commandMap->register("PureChich", new UsrInfo($this, "usrinfo1", $this->getMessage("cmds.usrinfo.desc") . ' #64FF00'));
