...
class Groups extends Command implements PluginIdentifiableCommand
{
    ...
    */
    ...
    public function __construct(PureChich $plugin, $name, $description)
    {
        ...
        $this->setPermission("pchich.command.groups");
    }
    ...
    public function execute(CommandSender $sender, string $label, array $args) : bool
    {
        ...
        $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.groups.messages.all_registered_groups", implode(", ", $result)));
