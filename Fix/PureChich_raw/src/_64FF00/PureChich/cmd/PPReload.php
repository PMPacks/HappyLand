...
class PPReload extends Command implements PluginIdentifiableCommand
{
    ...
    */
    ...
    public function __construct(PureChich $plugin, $name, $description)
    {
        ...
        $this->setPermission("pchich.command.ppreload");
    }
    ...
    public function execute(CommandSender $sender, string $label, array $args) : bool
    {
        ...
        $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.ppreload.messages.successfully_reloaded"));
