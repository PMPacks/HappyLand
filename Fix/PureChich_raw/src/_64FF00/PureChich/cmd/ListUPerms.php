...
class ListUPerms extends Command implements PluginIdentifiableCommand
{
    ...
    */
    ...
    public function __construct(PureChich $plugin, $name, $description)
    {
        ...
        $this->setPermission("pchich.command.listuperms");
    }
    ...
    public function execute(CommandSender $sender, string $label, array $args) : bool
    {
        ...
        {
            $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.listuperms.usage"));
        ...
        {
            $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.listuperms.messages.no_user_perms", $player->getName()));
        ...
        $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.listuperms.messages.user_perms_list", $player->getName(), $pageNumber, $maxPageNumber));
