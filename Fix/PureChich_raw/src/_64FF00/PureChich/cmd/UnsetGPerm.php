...
class UnsetGPerm extends Command implements PluginIdentifiableCommand
{
    ...
    */
    ...
    public function __construct(PureChich $plugin, $name, $description)
    {
        ...
        $this->setPermission("pchich.command.unsetgperm");
    }
    ...
    public function execute(CommandSender $sender, string $label, array $args) : bool
    {
        ...
        {
            $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.unsetgperm.usage"));
        ...
        if($group == null) 
        {
            $sender->sendMessage(TextFormat::RED . PureChich::MAIN_PREFIX . ' '. $this->plugin->getMessage("cmds.unsetgperm.messages.group_not_exist", $args[0]));
        ...
        $sender->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.unsetgperm.messages.gperm_removed_successfully", $permission));
