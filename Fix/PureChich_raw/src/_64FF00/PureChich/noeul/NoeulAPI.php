...
class NoeulAPI
{
    ...
    */
    ...
    public function auth(Player $player)
    {
        ...
        $player->sendMessage(TextFormat::GREEN . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.ppsudo.messages.successfully_logged_in"));
    ...
    {
        $player->sendMessage(TextFormat::RED . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.ppsudo.messages.deauth_01", self::NOEUL_VERSION));
        $player->sendMessage(TextFormat::RED . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.ppsudo.messages.deauth_02"));

        $player->sendMessage(TextFormat::RED . PureChich::MAIN_PREFIX . ' ' . $this->plugin->getMessage("cmds.ppsudo.messages.deauth_03"));
    }
