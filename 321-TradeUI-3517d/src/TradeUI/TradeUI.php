	...
	public function setEconomyProvider(EconomyProvider $provider){
        ...
        public function getBuyOrSellForm(Player $player) {
               ...
               // $content .= RandomUtils::colorMessage("&l&e===========================\n");
                $content .= RandomUtils::colorMessage("&l§bXin Chào, {$username}!\n\n");
                $content .= RandomUtils::colorMessage("&l§aNếu bạn muốn bán mặt hàng của bạn nhấn §6[BÁN]\n");
                $content .= RandomUtils::colorMessage("&l§a Nếu bạn muốn mua mặt hàng nào đó nhấn §6[MUA]\n\n");
                /*$content .= RandomUtils::colorMessage("&r&dIf you want to sell your own items\n");
                $content .= RandomUtils::colorMessage("&r&dclick 'SELL'!\n");
                $content .= RandomUtils::colorMessage("&l&e===========================\n");*/
                $form->setContent($content);
                $form->setButton(RandomUtils::colorMessage("§6[MUA]"));
                $form->setButton(RandomUtils::colorMessage("§6[BÁN]"));
                $form->send($player);
        }
